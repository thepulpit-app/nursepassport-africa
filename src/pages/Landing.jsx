        ...
        <div className="section">
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#F0FDF4', border: '1px solid #BBF7D0', borderRadius: '99px', padding: '6px 16px', marginBottom: '16px' }}>
              <span style={{ color: '#22C55E', fontSize: '13px', fontWeight: '700' }}>📚 Evidence-Based Courses</span>
            </div>
            <h2 style={{ fontSize: 'clamp(24px, 4vw, 40px)', fontWeight: '900', color: '#0A2540', marginBottom: '12px' }}>
          ...
          <div className="exam-grid" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '16px' }}>
            {[
              { emoji: '🚨', title: 'Obstetric Emergencies', desc: 'PPH, eclampsia, shoulder dystocia, cord prolapse — PROMPT-certified curriculum.' },
              { emoji: '💉', title: 'Basic Life Support (BLS)', desc: 'AHA and ERC-aligned. Adult CPR, AED, choking management and paediatric BLS.' },
              { emoji: '🎓', title: 'NMC OSCE Preparation', desc: 'Full mock OSCE experience for nurses preparing for UK registration.' },
            ].map((course, i) => (
          ...
          <div style={{ textAlign: 'center', marginTop: '32px' }}>
            <p style={{ color: '#94A3B8', fontSize: '14px', margin: 0 }}>
              🏆 Every completed course earns a verifiable <strong style={{ color: '#0A2540' }}>AMCC-certified certificate</strong> with a unique QR code — ready for your CV and employer verification.
            </p>
          </div>
        </div>
      </section>
